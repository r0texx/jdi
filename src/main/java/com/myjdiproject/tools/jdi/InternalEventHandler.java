...
import com.myjdiproject.jdi.ClassNotPreparedException;
import com.myjdiproject.jdi.InconsistentDebugInfoException;
import com.myjdiproject.jdi.ObjectCollectedException;
import com.myjdiproject.jdi.VMDisconnectedException;
import com.myjdiproject.jdi.VMOutOfMemoryException;
            ...
            while (true) {
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (event instanceof ClassUnloadEvent cuEvent) {
